...
function drawEditBody(){
   ...
   <div class="edit-page" >
      <form action="../actions/update_user.php" method="post" enctype="multipart/form-data">
         ...
         <label  ><h5>New Password:</h5><input type="password" name="pass" placeholder="Change Only if you want to change pass"> </label>
         <label  ><h5>Confirm Password</h5><input type="password" name="pass" value=""> </label>
